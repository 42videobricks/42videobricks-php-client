...
/**
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Api42Vb\Client\Model\Live|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Api42Vb\Client\Model\Live|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string[]|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    public function getLivesCaptureSources(string $contentType = self::contentTypes['getLivesCaptureSources'][0])
    {
        list($response) = $this->getLivesCaptureSourcesWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of string[]|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation startStopLiveById
     *
     * Active a live
     *
     * @param  string $live_id Id of the live (required)
     * @param  string $action action name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['startStopLiveById'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function startStopLiveById($live_id, $action, string $contentType = self::contentTypes['startStopLiveById'][0])
    {
        $this->startStopLiveByIdWithHttpInfo($live_id, $action, $contentType);
    }

    /**
     * Operation startStopLiveByIdWithHttpInfo
     *
     * Active a live
     *
     * @param  string $live_id Id of the live (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function startStopLiveByIdWithHttpInfo($live_id, $action, string $contentType = self::contentTypes['startStopLiveById'][0])
    {
        $request = $this->startStopLiveByIdRequest($live_id, $action, $contentType);
    ...
    /**
     * Operation startStopLiveByIdAsync
     *
     * Active a live
     *
     * @param  string $live_id Id of the live (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startStopLiveByIdAsync($live_id, $action, string $contentType = self::contentTypes['startStopLiveById'][0])
    {
        return $this->startStopLiveByIdAsyncWithHttpInfo($live_id, $action, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation startStopLiveByIdAsyncWithHttpInfo
     *
     * Active a live
     *
     * @param  string $live_id Id of the live (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function startStopLiveByIdAsyncWithHttpInfo($live_id, $action, string $contentType = self::contentTypes['startStopLiveById'][0])
    {
        $returnType = '';
        $request = $this->startStopLiveByIdRequest($live_id, $action, $contentType);
    ...
    /**
     * Create request for operation 'startStopLiveById'
     *
     * @param  string $live_id Id of the live (required)
     * @param  string $action action name (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['startStopLiveById'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function startStopLiveByIdRequest($live_id, $action, string $contentType = self::contentTypes['startStopLiveById'][0])
    {

        // verify the required parameter 'live_id' is set
        if ($live_id === null || (is_array($live_id) && count($live_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $live_id when calling startStopLiveById'
            );
        }
        ...
        if ($action === null || (is_array($action) && count($action) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $action when calling startStopLiveById'
            );
        }


        $resourcePath = '/lives/{liveId}/{action}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
