...
/**
    ...
    /**
     * Operation getDataVideoAnalytics
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDataVideoAnalytics'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Api42Vb\Client\Model\DataVideoAnalyticList|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    public function getDataVideoAnalytics($limit = null, $offset = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getDataVideoAnalytics'][0])
    {
        list($response) = $this->getDataVideoAnalyticsWithHttpInfo($limit, $offset, $start_date, $end_date, $contentType);
        return $response;
    }

    /**
     * Operation getDataVideoAnalyticsWithHttpInfo
     *
     * List Video Analytics KPIs
     *
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Api42Vb\Client\Model\DataVideoAnalyticList|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDataVideoAnalyticsWithHttpInfo($limit = null, $offset = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getDataVideoAnalytics'][0])
    {
        $request = $this->getDataVideoAnalyticsRequest($limit, $offset, $start_date, $end_date, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Api42Vb\Client\Model\DataVideoAnalyticList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Api42Vb\Client\Model\DataVideoAnalyticList' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Api42Vb\Client\Model\DataVideoAnalyticList', []),
            ...
            $returnType = '\Api42Vb\Client\Model\DataVideoAnalyticList';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Api42Vb\Client\Model\DataVideoAnalyticList',
    ...
    /**
     * Operation getDataVideoAnalyticsAsync
     *
     * List Video Analytics KPIs
     *
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     ...
     */
    public function getDataVideoAnalyticsAsync($limit = null, $offset = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getDataVideoAnalytics'][0])
    {
        return $this->getDataVideoAnalyticsAsyncWithHttpInfo($limit, $offset, $start_date, $end_date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDataVideoAnalyticsAsyncWithHttpInfo
     *
     * List Video Analytics KPIs
     *
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDataVideoAnalyticsAsyncWithHttpInfo($limit = null, $offset = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getDataVideoAnalytics'][0])
    {
        $returnType = '\Api42Vb\Client\Model\DataVideoAnalyticList';
        $request = $this->getDataVideoAnalyticsRequest($limit, $offset, $start_date, $end_date, $contentType);
    ...
    /**
     * Create request for operation 'getDataVideoAnalytics'
     *
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     * @param  int $offset offset for pagination (optional)
     * @param  string $start_date Start date for the period (optional)
     ...
     */
    public function getDataVideoAnalyticsRequest($limit = null, $offset = null, $start_date = null, $end_date = null, string $contentType = self::contentTypes['getDataVideoAnalytics'][0])
    {

        if ($limit !== null && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DataApi.getDataVideoAnalytics, must be smaller than or equal to 1000.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling DataApi.getDataVideoAnalytics, must be bigger than or equal to 1.');
        }
        ...
        $resourcePath = '/data/videos/analytics';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
