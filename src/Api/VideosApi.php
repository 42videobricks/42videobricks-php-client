...
/**
    ...
    /**
     * Operation deleteExportToVideo
     *
     * Delete an export of the video
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  int $export_id exportId (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteExportToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteExportToVideo($video_id, $format, $export_id = null, string $contentType = self::contentTypes['deleteExportToVideo'][0])
    {
        $this->deleteExportToVideoWithHttpInfo($video_id, $format, $export_id, $contentType);
    }

    /**
     * Operation deleteExportToVideoWithHttpInfo
     *
     * Delete an export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteExportToVideoWithHttpInfo($video_id, $format, $export_id = null, string $contentType = self::contentTypes['deleteExportToVideo'][0])
    {
        $request = $this->deleteExportToVideoRequest($video_id, $format, $export_id, $contentType);
    ...
    /**
     * Operation deleteExportToVideoAsync
     *
     * Delete an export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteExportToVideoAsync($video_id, $format, $export_id = null, string $contentType = self::contentTypes['deleteExportToVideo'][0])
    {
        return $this->deleteExportToVideoAsyncWithHttpInfo($video_id, $format, $export_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteExportToVideoAsyncWithHttpInfo
     *
     * Delete an export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteExportToVideoAsyncWithHttpInfo($video_id, $format, $export_id = null, string $contentType = self::contentTypes['deleteExportToVideo'][0])
    {
        $returnType = '';
        $request = $this->deleteExportToVideoRequest($video_id, $format, $export_id, $contentType);
    ...
    /**
     * Create request for operation 'deleteExportToVideo'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  int $export_id exportId (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteExportToVideoRequest($video_id, $format, $export_id = null, string $contentType = self::contentTypes['deleteExportToVideo'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling deleteExportToVideo'
            );
        }
        ...
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling deleteExportToVideo'
            );
        }



        $resourcePath = '/videos/{videoId}/exports/{format}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation deleteLinkToVideo
     *
     * Delete a link
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $link_type Type of attachment (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteLinkToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteLinkToVideo($video_id, $link_type, string $contentType = self::contentTypes['deleteLinkToVideo'][0])
    {
        $this->deleteLinkToVideoWithHttpInfo($video_id, $link_type, $contentType);
    }

    /**
     * Operation deleteLinkToVideoWithHttpInfo
     *
     * Delete a link
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteLinkToVideoWithHttpInfo($video_id, $link_type, string $contentType = self::contentTypes['deleteLinkToVideo'][0])
    {
        $request = $this->deleteLinkToVideoRequest($video_id, $link_type, $contentType);
    ...
    /**
     * Operation deleteLinkToVideoAsync
     *
     * Delete a link
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLinkToVideoAsync($video_id, $link_type, string $contentType = self::contentTypes['deleteLinkToVideo'][0])
    {
        return $this->deleteLinkToVideoAsyncWithHttpInfo($video_id, $link_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteLinkToVideoAsyncWithHttpInfo
     *
     * Delete a link
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLinkToVideoAsyncWithHttpInfo($video_id, $link_type, string $contentType = self::contentTypes['deleteLinkToVideo'][0])
    {
        $returnType = '';
        $request = $this->deleteLinkToVideoRequest($video_id, $link_type, $contentType);
    ...
    /**
     * Create request for operation 'deleteLinkToVideo'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $link_type Type of attachment (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteLinkToVideo'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteLinkToVideoRequest($video_id, $link_type, string $contentType = self::contentTypes['deleteLinkToVideo'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling deleteLinkToVideo'
            );
        }
        ...
        if ($link_type === null || (is_array($link_type) && count($link_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link_type when calling deleteLinkToVideo'
            );
        }


        $resourcePath = '/videos/{videoId}/links/{linkType}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Api42Vb\Client\Model\Attachment|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    ...
    {
        list($response) = $this->getAttachmentByVideoIdWithHttpInfo($video_id, $attachment_type, $locale, $contentType);
        return $response;
    }
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Api42Vb\Client\Model\Attachment|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAttachmentByVideoIdWithHttpInfo($video_id, $attachment_type, $locale, string $contentType = self::contentTypes['getAttachmentByVideoId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Api42Vb\Client\Model\Attachment' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Api42Vb\Client\Model\Attachment' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Api42Vb\Client\Model\Attachment', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Api42Vb\Client\Model\Attachment';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Api42Vb\Client\Model\Attachment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    ...
    {
        list($response) = $this->getAttachmentFileByVideoIdWithHttpInfo($video_id, $attachment_type, $locale, $contentType);
        return $response;
    }
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of string|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation getDetailToVideoById
     *
     * Get the detail of metadatas
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDetailToVideoById'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Api42Vb\Client\Model\VideoDetail|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    public function getDetailToVideoById($video_id, string $contentType = self::contentTypes['getDetailToVideoById'][0])
    {
        list($response) = $this->getDetailToVideoByIdWithHttpInfo($video_id, $contentType);
        return $response;
    }

    /**
     * Operation getDetailToVideoByIdWithHttpInfo
     *
     * Get the detail of metadatas
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Api42Vb\Client\Model\VideoDetail|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDetailToVideoByIdWithHttpInfo($video_id, string $contentType = self::contentTypes['getDetailToVideoById'][0])
    {
        $request = $this->getDetailToVideoByIdRequest($video_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Api42Vb\Client\Model\VideoDetail' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Api42Vb\Client\Model\VideoDetail' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Api42Vb\Client\Model\VideoDetail', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Api42Vb\Client\Model\VideoDetail';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Api42Vb\Client\Model\VideoDetail',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getDetailToVideoByIdAsync
     *
     * Get the detail of metadatas
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDetailToVideoByIdAsync($video_id, string $contentType = self::contentTypes['getDetailToVideoById'][0])
    {
        return $this->getDetailToVideoByIdAsyncWithHttpInfo($video_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDetailToVideoByIdAsyncWithHttpInfo
     *
     * Get the detail of metadatas
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDetailToVideoByIdAsyncWithHttpInfo($video_id, string $contentType = self::contentTypes['getDetailToVideoById'][0])
    {
        $returnType = '\Api42Vb\Client\Model\VideoDetail';
        $request = $this->getDetailToVideoByIdRequest($video_id, $contentType);
    ...
    /**
     * Create request for operation 'getDetailToVideoById'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDetailToVideoById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDetailToVideoByIdRequest($video_id, string $contentType = self::contentTypes['getDetailToVideoById'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling getDetailToVideoById'
            );
        }


        $resourcePath = '/videos/{videoId}/detail';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getExportToVideoById
     *
     ...
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     * @param  int $offset offset for pagination (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getExportToVideoById'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Api42Vb\Client\Model\ExportList|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    public function getExportToVideoById($video_id, $format = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getExportToVideoById'][0])
    {
        list($response) = $this->getExportToVideoByIdWithHttpInfo($video_id, $format, $limit, $offset, $contentType);
        return $response;
    }

    /**
     * Operation getExportToVideoByIdWithHttpInfo
     *
     * Get the list exports of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Api42Vb\Client\Model\ExportList|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExportToVideoByIdWithHttpInfo($video_id, $format = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getExportToVideoById'][0])
    {
        $request = $this->getExportToVideoByIdRequest($video_id, $format, $limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Api42Vb\Client\Model\ExportList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Api42Vb\Client\Model\ExportList' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Api42Vb\Client\Model\ExportList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Api42Vb\Client\Model\ExportList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Api42Vb\Client\Model\ExportList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getExportToVideoByIdAsync
     *
     * Get the list exports of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExportToVideoByIdAsync($video_id, $format = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getExportToVideoById'][0])
    {
        return $this->getExportToVideoByIdAsyncWithHttpInfo($video_id, $format, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExportToVideoByIdAsyncWithHttpInfo
     *
     * Get the list exports of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExportToVideoByIdAsyncWithHttpInfo($video_id, $format = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getExportToVideoById'][0])
    {
        $returnType = '\Api42Vb\Client\Model\ExportList';
        $request = $this->getExportToVideoByIdRequest($video_id, $format, $limit, $offset, $contentType);
    ...
    /**
     * Create request for operation 'getExportToVideoById'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format format (optional)
     * @param  int $limit Number of elements to return (default&#x3D;10) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExportToVideoByIdRequest($video_id, $format = null, $limit = null, $offset = null, string $contentType = self::contentTypes['getExportToVideoById'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling getExportToVideoById'
            );
        }


        if ($limit !== null && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling VideosApi.getExportToVideoById, must be smaller than or equal to 1000.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling VideosApi.getExportToVideoById, must be bigger than or equal to 1.');
        }
        


        $resourcePath = '/videos/{videoId}/exports';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getExportUrlToVideoById
     *
     ...
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  int $export_id exportId (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getExportUrlToVideoById'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error
     */
    public function getExportUrlToVideoById($video_id, $format, $export_id = null, string $contentType = self::contentTypes['getExportUrlToVideoById'][0])
    {
        list($response) = $this->getExportUrlToVideoByIdWithHttpInfo($video_id, $format, $export_id, $contentType);
        return $response;
    }

    /**
     * Operation getExportUrlToVideoByIdWithHttpInfo
     *
     * Get an url of the export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return array of string|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error|\Api42Vb\Client\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExportUrlToVideoByIdWithHttpInfo($video_id, $format, $export_id = null, string $contentType = self::contentTypes['getExportUrlToVideoById'][0])
    {
        $request = $this->getExportUrlToVideoByIdRequest($video_id, $format, $export_id, $contentType);
    ...
    /**
     * Operation getExportUrlToVideoByIdAsync
     *
     * Get an url of the export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExportUrlToVideoByIdAsync($video_id, $format, $export_id = null, string $contentType = self::contentTypes['getExportUrlToVideoById'][0])
    {
        return $this->getExportUrlToVideoByIdAsyncWithHttpInfo($video_id, $format, $export_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExportUrlToVideoByIdAsyncWithHttpInfo
     *
     * Get an url of the export of the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExportUrlToVideoByIdAsyncWithHttpInfo($video_id, $format, $export_id = null, string $contentType = self::contentTypes['getExportUrlToVideoById'][0])
    {
        $returnType = 'string';
        $request = $this->getExportUrlToVideoByIdRequest($video_id, $format, $export_id, $contentType);
    ...
    /**
     * Create request for operation 'getExportUrlToVideoById'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  int $export_id exportId (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExportUrlToVideoByIdRequest($video_id, $format, $export_id = null, string $contentType = self::contentTypes['getExportUrlToVideoById'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling getExportUrlToVideoById'
            );
        }
        ...
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling getExportUrlToVideoById'
            );
        }
    ...
    /**
     * Operation moveEnvironmentVideoById
     *
     * Update environment of video
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $environment Name of environment (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveEnvironmentVideoById'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function moveEnvironmentVideoById($video_id, $environment, string $contentType = self::contentTypes['moveEnvironmentVideoById'][0])
    {
        $this->moveEnvironmentVideoByIdWithHttpInfo($video_id, $environment, $contentType);
    }

    /**
     * Operation moveEnvironmentVideoByIdWithHttpInfo
     *
     * Update environment of video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function moveEnvironmentVideoByIdWithHttpInfo($video_id, $environment, string $contentType = self::contentTypes['moveEnvironmentVideoById'][0])
    {
        $request = $this->moveEnvironmentVideoByIdRequest($video_id, $environment, $contentType);
    ...
    /**
     * Operation moveEnvironmentVideoByIdAsync
     *
     * Update environment of video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function moveEnvironmentVideoByIdAsync($video_id, $environment, string $contentType = self::contentTypes['moveEnvironmentVideoById'][0])
    {
        return $this->moveEnvironmentVideoByIdAsyncWithHttpInfo($video_id, $environment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation moveEnvironmentVideoByIdAsyncWithHttpInfo
     *
     * Update environment of video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function moveEnvironmentVideoByIdAsyncWithHttpInfo($video_id, $environment, string $contentType = self::contentTypes['moveEnvironmentVideoById'][0])
    {
        $returnType = '';
        $request = $this->moveEnvironmentVideoByIdRequest($video_id, $environment, $contentType);
    ...
    /**
     * Create request for operation 'moveEnvironmentVideoById'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $environment Name of environment (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['moveEnvironmentVideoById'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function moveEnvironmentVideoByIdRequest($video_id, $environment, string $contentType = self::contentTypes['moveEnvironmentVideoById'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling moveEnvironmentVideoById'
            );
        }
        ...
        if ($environment === null || (is_array($environment) && count($environment) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment when calling moveEnvironmentVideoById'
            );
        }


        $resourcePath = '/videos/{videoId}/moveTo/{environment}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation postExportToVideo
     *
     * Add export to the video
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  \Api42Vb\Client\Model\ExportProperties $export_properties export_properties (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postExportToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postExportToVideo($video_id, $format, $export_properties, string $contentType = self::contentTypes['postExportToVideo'][0])
    {
        $this->postExportToVideoWithHttpInfo($video_id, $format, $export_properties, $contentType);
    }

    /**
     * Operation postExportToVideoWithHttpInfo
     *
     * Add export to the video
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  \Api42Vb\Client\Model\ExportProperties $export_properties (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postExportToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postExportToVideoWithHttpInfo($video_id, $format, $export_properties, string $contentType = self::contentTypes['postExportToVideo'][0])
    {
        $request = $this->postExportToVideoRequest($video_id, $format, $export_properties, $contentType);
    ...
    /**
     * Operation postExportToVideoAsync
     *
     * Add export to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postExportToVideoAsync($video_id, $format, $export_properties, string $contentType = self::contentTypes['postExportToVideo'][0])
    {
        return $this->postExportToVideoAsyncWithHttpInfo($video_id, $format, $export_properties, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postExportToVideoAsyncWithHttpInfo
     *
     * Add export to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postExportToVideoAsyncWithHttpInfo($video_id, $format, $export_properties, string $contentType = self::contentTypes['postExportToVideo'][0])
    {
        $returnType = '';
        $request = $this->postExportToVideoRequest($video_id, $format, $export_properties, $contentType);
    ...
    /**
     * Create request for operation 'postExportToVideo'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $format The format to export - GIF : animated image file - BACKGROUND : a light format video (required)
     * @param  \Api42Vb\Client\Model\ExportProperties $export_properties (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postExportToVideoRequest($video_id, $format, $export_properties, string $contentType = self::contentTypes['postExportToVideo'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling postExportToVideo'
            );
        }
        ...
        if ($format === null || (is_array($format) && count($format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $format when calling postExportToVideo'
            );
        }

        // verify the required parameter 'export_properties' is set
        if ($export_properties === null || (is_array($export_properties) && count($export_properties) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $export_properties when calling postExportToVideo'
            );
        }
        ...
        // for model (json/xml)
        if (isset($export_properties)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($export_properties));
            } else {
                $httpBody = $export_properties;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation postLinkToVideo
     *
     * Add link to the video
     *
     * @param  string $video_id Id of the video (required)
     * @param  \Api42Vb\Client\Model\Link $link link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postLinkToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function postLinkToVideo($video_id, $link, string $contentType = self::contentTypes['postLinkToVideo'][0])
    {
        $this->postLinkToVideoWithHttpInfo($video_id, $link, $contentType);
    }

    /**
     * Operation postLinkToVideoWithHttpInfo
     *
     * Add link to the video
     *
     * @param  string $video_id Id of the video (required)
     * @param  \Api42Vb\Client\Model\Link $link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postLinkToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postLinkToVideoWithHttpInfo($video_id, $link, string $contentType = self::contentTypes['postLinkToVideo'][0])
    {
        $request = $this->postLinkToVideoRequest($video_id, $link, $contentType);
    ...
    /**
     * Operation postLinkToVideoAsync
     *
     * Add link to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postLinkToVideoAsync($video_id, $link, string $contentType = self::contentTypes['postLinkToVideo'][0])
    {
        return $this->postLinkToVideoAsyncWithHttpInfo($video_id, $link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postLinkToVideoAsyncWithHttpInfo
     *
     * Add link to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postLinkToVideoAsyncWithHttpInfo($video_id, $link, string $contentType = self::contentTypes['postLinkToVideo'][0])
    {
        $returnType = '';
        $request = $this->postLinkToVideoRequest($video_id, $link, $contentType);
    ...
    /**
     * Create request for operation 'postLinkToVideo'
     *
     * @param  string $video_id Id of the video (required)
     * @param  \Api42Vb\Client\Model\Link $link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postLinkToVideo'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postLinkToVideoRequest($video_id, $link, string $contentType = self::contentTypes['postLinkToVideo'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling postLinkToVideo'
            );
        }
        ...
        if ($link === null || (is_array($link) && count($link) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link when calling postLinkToVideo'
            );
        }


        $resourcePath = '/videos/{videoId}/links';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($link)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($link));
            } else {
                $httpBody = $link;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @param  string $link_type Type of attachment (required)
     * @param  \Api42Vb\Client\Model\Link $link link (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putLinkToVideo'] to see the possible values for this operation
     *
     * @throws \Api42Vb\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function putLinkToVideo($video_id, $link_type, $link, string $contentType = self::contentTypes['putLinkToVideo'][0])
    {
        $this->putLinkToVideoWithHttpInfo($video_id, $link_type, $link, $contentType);
    }

    /**
     * Operation putLinkToVideoWithHttpInfo
     *
     * Update link to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function putLinkToVideoWithHttpInfo($video_id, $link_type, $link, string $contentType = self::contentTypes['putLinkToVideo'][0])
    {
        $request = $this->putLinkToVideoRequest($video_id, $link_type, $link, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putLinkToVideoAsync($video_id, $link_type, $link, string $contentType = self::contentTypes['putLinkToVideo'][0])
    {
        return $this->putLinkToVideoAsyncWithHttpInfo($video_id, $link_type, $link, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation putLinkToVideoAsyncWithHttpInfo
     *
     * Update link to the video
     *
     * @param  string $video_id Id of the video (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putLinkToVideoAsyncWithHttpInfo($video_id, $link_type, $link, string $contentType = self::contentTypes['putLinkToVideo'][0])
    {
        $returnType = '';
        $request = $this->putLinkToVideoRequest($video_id, $link_type, $link, $contentType);
    ...
    /**
     * Create request for operation 'putLinkToVideo'
     *
     * @param  string $video_id Id of the video (required)
     * @param  string $link_type Type of attachment (required)
     * @param  \Api42Vb\Client\Model\Link $link (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putLinkToVideoRequest($video_id, $link_type, $link, string $contentType = self::contentTypes['putLinkToVideo'][0])
    {

        // verify the required parameter 'video_id' is set
        if ($video_id === null || (is_array($video_id) && count($video_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $video_id when calling putLinkToVideo'
            );
        }
        ...
        if ($link_type === null || (is_array($link_type) && count($link_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link_type when calling putLinkToVideo'
            );
        }
        ...
        if ($link === null || (is_array($link) && count($link) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $link when calling putLinkToVideo'
            );
        }
