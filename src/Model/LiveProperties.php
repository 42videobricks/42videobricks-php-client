...
class LiveProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets streaming_type
     *
     * @param string|null $streaming_type RTMP (Real-Time Messaging Protocol): A streaming protocol developed by Adobe for transmitting audio, video, and data streams in real-time over the Internet. SRT (Secure Reliable Transport): An open-source protocol that optimizes live video streaming over unstable networks, ensuring security and reliability.
     *
     * @return self
     */
