...
class WebhookProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENT_TYPE_VIDEO_STATUS = 'VIDEO_STATUS';
    public const EVENT_TYPE_VIDEO_TRANSCODING_PROGRESS = 'VIDEO_TRANSCODING_PROGRESS';
    ...
    {
        return [
            self::EVENT_TYPE_VIDEO_STATUS,
            self::EVENT_TYPE_VIDEO_TRANSCODING_PROGRESS,
        ];
    }
