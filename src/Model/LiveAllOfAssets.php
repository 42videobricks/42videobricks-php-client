...
/**
 * LiveAllOfAssets Class Doc Comment
 *
 * @category Class
 * @package  Api42Vb\Client
 * @author   OpenAPI Generator team
 ...
 */
class LiveAllOfAssets implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Live_allOf_assets';
    ...
    */
     ...
     * Sets thumbnail
     *
     * @param string|null $thumbnail Url of the live thumbnail
     *
     * @return self
     */
     ...
     * Sets player
     *
     * @param string|null $player Url to the live player code
     *
     * @return self
     */
     ...
     * Sets stream
     *
     * @param string|null $stream Url to the live player stream
     *
     * @return self
     */
